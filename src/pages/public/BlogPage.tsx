export function BlogPage() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
      <h1 className="font-display text-5xl text-slate-950 dark:text-white">Noticias y articulos</h1>
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        {[
          ['Como evaluar cuidadores de noche', 'Confianza y seguridad'],
          ['El futuro del cuidado asistido por operaciones', 'Operaciones'],
          ['Por que subir comprobantes mejora la confianza', 'Pagos'],
        ].map(([title, tag]) => (
