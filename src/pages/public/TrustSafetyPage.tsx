export function TrustSafetyPage() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
      <p className="text-sm uppercase tracking-[0.32em] text-cyan-600 dark:text-cyan-300">Confianza y seguridad</p>
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-2">
        {[
          ['Validacion de identidad', 'Cedula, selfie, correo OTP y validaciones con estados y aprobaciones.'],
          ['Revision de pagos', 'Comprobantes, revisiones manuales y apoyo de verificacion automatica.'],
          ['Operacion de riesgo', 'Centro de alertas y auditoria para equipos de revision.'],
          ['Escalamiento de soporte', 'Reportes y flujos de respuesta para incidentes sensibles.'],
